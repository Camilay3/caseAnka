    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen pt-4 pb-10 px-8 sm:pt-0 sm:px-20 sm:pb-10 gap-10 font-[family-name:var(--font-geist-sans)] bg-[#a790d4] dark:bg-[#2e1b45]">
      <main className="flex flex-col gap-[32px] row-start-2 sm:items-center">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 hover:bg-[#6e2194] dark:hover:bg-[#dbbfff] font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto"
            href="/clientes"
          >
            Clientes
          </a>
          <a
            className="rounded-full border border-solid border-black/[.5] dark:border-white/[.5] transition-colors flex items-center justify-center hover:bg-[#dbbfff] dark:hover:bg-[#994ecf] hover:border-transparent font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[178px]"
            href="/ativos"
          >
            Ativos financeiros
          </a>
